...
def capture_mat_all(original_path,domain="",dataset="",class_n=0):
        ...
        for i in file_name_list:
            ...
            if dataset in ["bearing-sdust","bearing-hust","bearing-sdust","bearing-pu","CWRU5","CWRU7","CWRU9","CWRU10"]:
...
class Bearing_priv():
    ...
    def __init__(self,args=None):
        ...
        if self.setting == 'domain_skew' and self.dataset=="bearing-hust":
            self.DOMAINS_LIST = ['65', '70', '75', '80']
            self.percent_dict = {'65': 0.5, '70': 0.5, '75': 0.5, '80': 0.5}#测试集比例
            self.N_CLASS = 9
